...
class CustomQuadcopterEnvWindow(BaseEnvWindow):
    """Window manager for the custom quadcopter environment."""

    def __init__(self, env: CustomQuadcopterEnv, window_name: str = "IsaacLab"):
...
class CustomQuadcopterEnvCfg(DirectRLEnvCfg):
    ...
    ui_window_class_type = CustomQuadcopterEnvWindow
